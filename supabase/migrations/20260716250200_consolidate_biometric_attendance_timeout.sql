-- The rebuild touches ~57k rows; raise statement_timeout for this function so it
-- isn't cut off by PostgREST's default. Redefines consolidate_biometric_attendance()
